...
class ProduitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produit" do
    assert_difference('Produit.count') do
      post produits_url, params: { produit: { autre_colonne_sdfqsdf: @produit.autre_colonne_sdfqsdf, encore: @produit.encore, et_une_autre: @produit.et_une_autre, nom: @produit.nom, puht: @produit.puht, test: @produit.test } }
    end
  ...
  test "should update produit" do
    patch produit_url(@produit), params: { produit: { autre_colonne_sdfqsdf: @produit.autre_colonne_sdfqsdf, encore: @produit.encore, et_une_autre: @produit.et_une_autre, nom: @produit.nom, puht: @produit.puht, test: @produit.test } }
